...
SELECT BTBOOKTRANSTYPE,TITITLEID FROM LIBBOOKTRANS WHERE TITITLEID=(SELECT TITITLEID FROM LIBBOOKTRANS GROUP BY TITITLEID HAVING COUNT(TITITLEID)=(SELECT MAX(COUNT(TITITLEID)) FROM LIBBOOKTRANS GROUP BY TITITLEID));
